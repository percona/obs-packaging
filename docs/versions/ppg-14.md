...
| percona-pgbackrest | ppg:14:containers:ubi8 | percona-pgbackrest | 2.58.0 | `2.58.0-2.1` `2.58.0` `latest` | percona-pgbackrest 2.58.0-2.4 |
| percona-pgbouncer | ppg:14:containers:ubi8 | percona-pgbouncer | 1.25.2 | `1.25.2-2.1` `1.25.2` `latest` | c-ares 1.19.1-1.1, percona-pgbouncer 1.25.2-1.4, python3.12-psycopg2 2.9.10-1.9 |
...
| percona-pgbackrest | ppg:14:containers:ubi9 | percona-pgbackrest | 2.58.0 | `2.58.0-2.1` `2.58.0` `latest` | percona-pgbackrest 2.58.0-2.4, percona-postgresql14-libs 14.23-5.1 |
| percona-pgbouncer | ppg:14:containers:ubi9 | percona-pgbouncer | 1.25.2 | `1.25.2-2.1` `1.25.2` `latest` | c-ares 1.19.1-1.8, percona-pgbouncer 1.25.2-1.4, percona-postgresql14-libs 14.23-5.1, python3.12-psycopg2 2.9.10-1.7 |
