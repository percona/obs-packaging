...
| percona-patroni | ppg:18 | 4.1.3-1+1.2 |
| percona-pg_cron | ppg:18 | 1.6.7-1+4.1 |
...
| percona-pgbouncer | ppg:18 | 1.25.2-1+1.2 |
| percona-pgpool-II | ppg:18 | 4.7.1-1+1.1 |
| percona-pgvector | ppg:18 | 0.8.2-1+3.1 |
| percona-postgis | ppg:18 | 3.5.6-1+1.1 |
| percona-postgresql | ppg:18 | 18.4-1+1.1 |
| percona-postgresql-common | ppg:18 | 290-1+1.1 |
| percona-ppg-server | ppg:18 | 18.4-1 |
| percona-ppg-server-ha | ppg:18 | 18.4-1 |
| percona-wal2json | ppg:18 | 2.6-1+4.1 |
| python3-attrs | ppg:18 | 22.1.0-1.7 |
| python3-blessed | ppg:18 | 1.22.0-1.7 |
| python3-boto3 | ppg:18 | 1.38.19-1.7 |
| python3-botocore | ppg:18 | 1.38.19-1.7 |
| python3-click | ppg:18 | 8.1.7-1.7 |
| python3-dateutil | ppg:18 | 2.9.0.post0-1.7 |
| python3-dns | ppg:18 | 1.15.0-1.7 |
| python3-etcd | ppg:18 | 0.4.5-1.7 |
| python3-kazoo | ppg:18 | 2.8.0-1.7 |
| python3-lz4 | ppg:18 | 4.3.3-1.7 |
| python3-prettytable | ppg:18 | 3.4.0-1.7 |
| python3-psutil | ppg:18 | 6.1.1-1.7 |
| python3-psycopg2 | ppg:18 | 2.9.10-1.11 |
| python3-py-consul | ppg:18 | 1.6.0-1.6 |
| python3-pysyncobj | ppg:18 | 0.3.10-1+1.2 |
| python3-six | ppg:18 | 1.17.0-1.7 |
| python3-wcwidth | ppg:18 | 0.2.13-1.7 |
| python3-zstandard | ppg:18 | 0.23.0-1.7 |
| sfcgal | ppg:18 | 2.2.0-2.4 |
| ydiff | ppg:18 | 1.4.2-1+1.2 |
