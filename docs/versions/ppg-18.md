...
| ------- | ------- | ------- |
| gosu | ppg:18:containers:ubi9 | 1.19-2.3 |
...
| python3-attrs | ppg:18 | 22.1.0-1.4 |
| python3-blessed | ppg:18 | 1.22.0-1.4 |
| python3-boto3 | ppg:18 | 1.38.19-1.4 |
| python3-botocore | ppg:18 | 1.38.19-1.4 |
| python3-click | ppg:18 | 8.1.7-1.4 |
| python3-dateutil | ppg:18 | 2.9.0.post0-1.4 |
| python3-dns | ppg:18 | 1.15.0-1.4 |
| python3-etcd | ppg:18 | 0.4.5-1.4 |
| python3-kazoo | ppg:18 | 2.8.0-1.4 |
| python3-lz4 | ppg:18 | 4.3.3-1.4 |
| python3-prettytable | ppg:18 | 3.4.0-1.4 |
| python3-psutil | ppg:18 | 6.1.1-1.4 |
| python3-psycopg2 | ppg:18 | 2.9.10-1.7 |
| python3-py-consul | ppg:18 | 1.6.0-1.3 |
| python3-pysyncobj | ppg:18 | 0.3.10-1+1.1 |
| python3-six | ppg:18 | 1.17.0-1.4 |
| python3-wcwidth | ppg:18 | 0.2.13-1.4 |
| python3-zstandard | ppg:18 | 0.23.0-1.4 |
| sfcgal | ppg:18 | 2.2.0-2.1 |
...
| ------- | ------- | ----- | ------- | ---- |
| percona-distribution-postgresql | ppg:18:containers:ubi9 | percona-distribution-postgresql | 18.3 | `18.3-1.14` `18.3` `18` |
| percona-distribution-postgresql-with-postgis | ppg:18:containers:ubi9 | percona-distribution-postgresql-with-postgis | 18.3 | `18.3-1.23` `18.3` `18` |
