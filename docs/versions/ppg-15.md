...
| percona-pgbackrest | ppg:15:containers:ubi8 | percona-pgbackrest | 2.58.0 | `2.58.0-2.1` `2.58.0` `latest` | percona-pgbackrest 2.58.0-2.4 |
| percona-pgbouncer | ppg:15:containers:ubi8 | percona-pgbouncer | 1.25.2 | `1.25.2-2.1` `1.25.2` `latest` | c-ares 1.19.1-1.1, percona-pgbouncer 1.25.2-1.3, python3.12-psycopg2 2.9.10-1.7 |
...
| percona-pgbackrest | ppg:15:containers:ubi9 | percona-pgbackrest | 2.58.0 | `2.58.0-2.1` `2.58.0` `latest` | percona-pgbackrest 2.58.0-2.4, percona-postgresql15-libs 15.18-4.1 |
| percona-pgbouncer | ppg:15:containers:ubi9 | percona-pgbouncer | 1.25.2 | `1.25.2-2.1` `1.25.2` `latest` | c-ares 1.19.1-1.8, percona-pgbouncer 1.25.2-1.4, percona-postgresql15-libs 15.18-4.1, python3.12-psycopg2 2.9.10-1.6 |
