...
| percona-pg-telemetry | ppg:16 | 1.2.0-1+1.1 |
| percona-pg_cron | ppg:16 | 1.6.7-1+1.1 |
| percona-pg_gather | ppg:16 | 33-1+1.1 |
| percona-pg_repack | ppg:16 | 1.5.3-1+1.1 |
| percona-pg_stat_monitor | ppg:16 | 2.3.2-1+1.1 |
| percona-pgaudit | ppg:16 | 16.1-1+1.1 |
| percona-pgaudit_set_user | ppg:16 | 4.2.0-1+1.1 |
| percona-pgbackrest | ppg:16 | 2.58.0-1+2.2 |
| percona-pgbadger | ppg:16 | 13.2-1+1.1 |
| percona-pgbouncer | ppg:16 | 1.25.2-1+1.2 |
| percona-pgpool-II | ppg:16 | 4.7.1-1+1.1 |
| percona-pgvector | ppg:16 | 0.8.3-1+1.1 |
| percona-postgis | ppg:16 | 3.5.7-1+2.1 |
| percona-postgresql | ppg:16 | 16.14-1+12.1 |
...
| percona-wal2json | ppg:16 | 2.6-1+1.1 |
...
| python3-psycopg2 | ppg:16 | 2.9.10-1.4 |
...
| ------- | ------- | ----- | ------- | ---- | ------------------ |
| percona-distribution-postgresql | ppg:16:containers:ubi8 | percona-distribution-postgresql | 16.14-1 | `16.14-1-1.7` `16.14-1` `16.14` `16` | gosu 1.19-6.7, percona-patroni 4.1.3-1.4, percona-patroni-etcd 4.1.3-1.4, percona-pg-telemetry16 1.2.0-1.13, percona-pg_cron_16 1.6.7-1.13, percona-pg_repack16 1.5.3-1.13, percona-pg_stat_monitor16 2.3.2-1.5, percona-pgaudit16 16.1-1.6, percona-pgaudit16_set_user 4.2.0-1.5, percona-pgbackrest 2.58.0-2.2, percona-pgvector_16 0.8.3-1.4, percona-pgvector_16-llvmjit 0.8.3-1.4, percona-postgresql-client-common 290-1.4, percona-postgresql-common 290-1.4, percona-postgresql16 16.14-12.1, percona-postgresql16-contrib 16.14-12.1, percona-postgresql16-libs 16.14-12.1, percona-postgresql16-llvmjit 16.14-12.1, percona-postgresql16-server 16.14-12.1, percona-telemetry-agent 1.0.14-9.3, percona-wal2json16 2.6-1.5, perl-JSON 4.03-2.5, python3-etcd 0.4.5-2.6, python3-ydiff 1.4.2-2.6, python3.12-click 8.1.7-2.6, python3.12-dateutil 2.9.0.post0-3.3, python3.12-dns 1.15.0-2.6, python3.12-etcd 0.4.5-2.6, python3.12-prettytable 3.4.0-2.6, python3.12-psutil 6.1.1-2.6, python3.12-psycopg2 2.9.10-1.5, python3.12-six 1.17.0-2.6, python3.12-wcwidth 0.2.13-2.6 |
| percona-distribution-postgresql-with-postgis | ppg:16:containers:ubi8 | percona-distribution-postgresql-with-postgis | 16.14-1 | `16.14-1-1.16` `16.14-1` `16.14` `16` | SFCGAL 2.2.0-4.3, blas 3.9.0-1.6, geos 3.13.1-1.6, gosu 1.19-6.7, lapack 3.9.0-1.6, percona-patroni 4.1.3-1.4, percona-patroni-etcd 4.1.3-1.4, percona-pg-telemetry16 1.2.0-1.13, percona-pg_cron_16 1.6.7-1.13, percona-pg_repack16 1.5.3-1.13, percona-pg_stat_monitor16 2.3.2-1.5, percona-pgaudit16 16.1-1.6, percona-pgaudit16_set_user 4.2.0-1.5, percona-pgbackrest 2.58.0-2.2, percona-pgvector_16 0.8.3-1.4, percona-pgvector_16-llvmjit 0.8.3-1.4, percona-postgis35_16 3.5.7-2.2, percona-postgis35_16-client 3.5.7-2.2, percona-postgis35_16-gui 3.5.7-2.2, percona-postgis35_16-llvmjit 3.5.7-2.2, percona-postgis35_16-utils 3.5.7-2.2, percona-postgresql-client-common 290-1.4, percona-postgresql-common 290-1.4, percona-postgresql16 16.14-12.1, percona-postgresql16-contrib 16.14-12.1, percona-postgresql16-libs 16.14-12.1, percona-postgresql16-llvmjit 16.14-12.1, percona-postgresql16-server 16.14-12.1, percona-telemetry-agent 1.0.14-9.3, percona-wal2json16 2.6-1.5, perl-JSON 4.03-2.5, python3-etcd 0.4.5-2.6, python3-ydiff 1.4.2-2.6, python3.12-click 8.1.7-2.6, python3.12-dateutil 2.9.0.post0-3.3, python3.12-dns 1.15.0-2.6, python3.12-etcd 0.4.5-2.6, python3.12-prettytable 3.4.0-2.6, python3.12-psutil 6.1.1-2.6, python3.12-psycopg2 2.9.10-1.5, python3.12-six 1.17.0-2.6, python3.12-wcwidth 0.2.13-2.6 |
| percona-pgbackrest | ppg:16:containers:ubi8 | percona-pgbackrest | 2.58.0 | `2.58.0-1.5` `2.58.0` `latest` | percona-pgbackrest 2.58.0-2.2 |
| percona-pgbouncer | ppg:16:containers:ubi8 | percona-pgbouncer | 1.25.2 | `1.25.2-1.6` `1.25.2` `latest` | c-ares 1.19.1-1.1, percona-pgbouncer 1.25.2-1.3, python3.12-psycopg2 2.9.10-1.5 |
| percona-distribution-postgresql | ppg:16:containers:ubi9 | percona-distribution-postgresql | 16.14-1 | `16.14-1-1.11` `16.14-1` `16.14` `16` | gosu 1.19-6.4, percona-patroni 4.1.3-1.2, percona-patroni-etcd 4.1.3-1.2, percona-pg-telemetry16 1.2.0-1.11, percona-pg_cron_16 1.6.7-1.11, percona-pg_repack16 1.5.3-1.11, percona-pg_stat_monitor16 2.3.2-1.4, percona-pgaudit16 16.1-1.6, percona-pgaudit16_set_user 4.2.0-1.4, percona-pgbackrest 2.58.0-2.2, percona-pgvector_16 0.8.3-1.3, percona-pgvector_16-llvmjit 0.8.3-1.3, percona-postgresql-client-common 290-1.2, percona-postgresql-common 290-1.2, percona-postgresql16 16.14-12.1, percona-postgresql16-contrib 16.14-12.1, percona-postgresql16-libs 16.14-12.1, percona-postgresql16-llvmjit 16.14-12.1, percona-postgresql16-server 16.14-12.1, percona-telemetry-agent 1.0.14-9.3, percona-wal2json16 2.6-1.4, perl-JSON 4.03-2.3, python3-etcd 0.4.5-2.3, python3-ydiff 1.4.2-2.3, python3.12-click 8.1.7-2.3, python3.12-dateutil 2.9.0.post0-3.2, python3.12-dns 1.15.0-2.3, python3.12-etcd 0.4.5-2.3, python3.12-prettytable 3.4.0-2.3, python3.12-psutil 6.1.1-2.3, python3.12-psycopg2 2.9.10-1.4, python3.12-six 1.17.0-2.3, python3.12-wcwidth 0.2.13-2.3 |
| percona-distribution-postgresql-with-postgis | ppg:16:containers:ubi9 | percona-distribution-postgresql-with-postgis | 16.14-1 | `16.14-1-1.15` `16.14-1` `16.14` `16` | SFCGAL 2.2.0-4.3, blas 3.9.0-1.7, flexiblas 3.0.4-2.4, flexiblas-netlib 3.0.4-2.4, flexiblas-netlib64 3.0.4-2.4, flexiblas-openblas-threads 3.0.4-2.4, geos 3.13.1-1.8, gosu 1.19-6.4, lapack 3.9.0-1.7, percona-patroni 4.1.3-1.2, percona-patroni-etcd 4.1.3-1.2, percona-pg-telemetry16 1.2.0-1.11, percona-pg_cron_16 1.6.7-1.11, percona-pg_repack16 1.5.3-1.11, percona-pg_stat_monitor16 2.3.2-1.4, percona-pgaudit16 16.1-1.6, percona-pgaudit16_set_user 4.2.0-1.4, percona-pgbackrest 2.58.0-2.2, percona-pgvector_16 0.8.3-1.3, percona-pgvector_16-llvmjit 0.8.3-1.3, percona-postgis35_16 3.5.7-2.2, percona-postgis35_16-client 3.5.7-2.2, percona-postgis35_16-gui 3.5.7-2.2, percona-postgis35_16-llvmjit 3.5.7-2.2, percona-postgis35_16-utils 3.5.7-2.2, percona-postgresql-client-common 290-1.2, percona-postgresql-common 290-1.2, percona-postgresql16 16.14-12.1, percona-postgresql16-contrib 16.14-12.1, percona-postgresql16-libs 16.14-12.1, percona-postgresql16-llvmjit 16.14-12.1, percona-postgresql16-server 16.14-12.1, percona-telemetry-agent 1.0.14-9.3, percona-wal2json16 2.6-1.4, perl-JSON 4.03-2.3, proj 9.6.0-2.4, proj-data 9.6.0-2.4, python3-etcd 0.4.5-2.3, python3-ydiff 1.4.2-2.3, python3.12-click 8.1.7-2.3, python3.12-dateutil 2.9.0.post0-3.2, python3.12-dns 1.15.0-2.3, python3.12-etcd 0.4.5-2.3, python3.12-prettytable 3.4.0-2.3, python3.12-psutil 6.1.1-2.3, python3.12-psycopg2 2.9.10-1.4, python3.12-six 1.17.0-2.3, python3.12-wcwidth 0.2.13-2.3 |
| percona-pgbackrest | ppg:16:containers:ubi9 | percona-pgbackrest | 2.58.0 | `2.58.0-1.8` `2.58.0` `latest` | percona-pgbackrest 2.58.0-2.2, percona-postgresql16-libs 16.14-12.1 |
| percona-pgbouncer | ppg:16:containers:ubi9 | percona-pgbouncer | 1.25.2 | `1.25.2-1.10` `1.25.2` `latest` | c-ares 1.19.1-1.8, percona-pgbouncer 1.25.2-1.4, percona-postgresql16-libs 16.14-12.1, python3.12-psycopg2 2.9.10-1.4 |
