...
| etcd | ppg:17 | 3.5.29-1+5.1 |
| percona-haproxy | ppg:17 | 2.8.18-1+1.1 |
| percona-patroni | ppg:17 | 4.1.1-1+5.1 |
| percona-pg-telemetry | ppg:17 | 1.2.0-1+3.2 |
| percona-pg_cron | ppg:17 | 1.6.7-0+1.1 |
| percona-pg_gather | ppg:17 | 32-1+3.1 |
...
| python3-psycopg2 | ppg:17 | 2.9.10-2.7 |
...
| ------- | ------- | ----- | ------- | ---- |
| percona-distribution-postgresql | ppg:17:containers:ubi9 | percona-distribution-postgresql | 17.9-2 | `17.9-2-1.1` `17.9-2` `17` |
| percona-distribution-postgresql-with-postgis | ppg:17:containers:ubi9 | percona-distribution-postgresql-with-postgis | 17.9-2 | `17.9-2-1.1` `17.9-2` `17` |
