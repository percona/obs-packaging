...
| percona-pg-telemetry | ppg:17 | 1.2.0-1+1.2 |
| percona-pg_gather | ppg:17 | 32-1+1.1 |
| percona-pg_repack | ppg:17 | 1.5.3-1+1.2 |
| percona-pg_stat_monitor | ppg:17 | 2.3.2-1+1.2 |
| percona-pg_tde | ppg:17 | 2.1.2-1+1.2 |
| percona-pgaudit | ppg:17 | 17.1-1+1.2 |
| percona-pgaudit_set_user | ppg:17 | 4.2.0-1+1.2 |
| percona-pgbackrest | ppg:17 | 2.58.0-1+1.2 |
| percona-pgbadger | ppg:17 | 13.2-1+1.1 |
| percona-pgbouncer | ppg:17 | 1.25.1-1+1.2 |
| percona-pgpool-II | ppg:17 | 4.7.0-1+1.2 |
| percona-pgvector | ppg:17 | 0.8.2-1+1.2 |
...
| ------- | ------- | ----- | ------- | ---- |
| percona-distribution-postgresql | ppg:17:containers:ubi9 | percona-distribution-postgresql | 17.9 | `17.9-1.4` `17.9` `17` |
| percona-distribution-postgresql-with-postgis | ppg:17:containers:ubi9 | percona-distribution-postgresql-with-postgis | 17.9 | `17.9-1.9` `17.9` `17` |
