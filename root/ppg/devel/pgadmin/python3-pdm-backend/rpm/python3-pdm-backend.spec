...
Name:           %{python3_pkgprefix}-pdm-backend
Version:        2.4.5
Release:        1%{?dist}
Summary:        The build backend used by PDM that supports latest packaging standards
License:        MIT
URL:            https://github.com/pdm-project/pdm-backend
Source0:        https://files.pythonhosted.org/packages/source/p/pdm-backend/pdm_backend-2.4.5.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n pdm_backend-2.4.5
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import pdm.backend"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 2.4.5-1
- Package pdm-backend 2.4.5 for Python 3.12 (pgAdmin 4 dependency stack)
