...
Name:           %{python3_pkgprefix}-shellingham
Version:        1.5.4
Release:        1%{?dist}
Summary:        Tool to Detect Surrounding Shell
License:        ISC
URL:            https://github.com/sarugaku/shellingham
Source0:        https://files.pythonhosted.org/packages/source/s/shellingham/shellingham-1.5.4.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n shellingham-1.5.4
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import shellingham"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 1.5.4-1
- Package shellingham 1.5.4 for Python 3.12 (pgAdmin 4 dependency stack)
