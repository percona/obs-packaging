...
Source0:        https://files.pythonhosted.org/packages/source/g/gssapi/gssapi-1.11.1.tar.gz
Vendor:         Percona, LLC
...
%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 1.11.1-1
- Package gssapi 1.11.1 for Python 3.12 (pgAdmin 4 dependency stack)
