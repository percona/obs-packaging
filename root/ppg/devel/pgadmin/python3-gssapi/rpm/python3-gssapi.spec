...
Name:           %{python3_pkgprefix}-gssapi
Version:        1.10.1
Release:        1%{?dist}
Summary:        Python GSSAPI Wrapper
License:        ISC
URL:            https://github.com/pythongssapi/python-gssapi
Source0:        https://files.pythonhosted.org/packages/source/g/gssapi/gssapi-1.10.1.tar.gz
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-decorator

Requires:       %{python3_pkgprefix}-decorator
...
%check
PYTHONPATH=%{buildroot}%{python3_sitearch} %{__ospython} -P -c "import gssapi"

%files
%{python3_sitearch}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 1.10.1-1
- Package gssapi 1.10.1 for Python 3.12 (pgAdmin 4 dependency stack)
