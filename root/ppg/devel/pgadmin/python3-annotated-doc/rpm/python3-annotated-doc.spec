...
Name:           %{python3_pkgprefix}-annotated-doc
Version:        0.0.5
Release:        1%{?dist}
Summary:        Document parameters, class attributes, return types, and variables inline, with Annotated
License:        MIT
URL:            https://github.com/fastapi/annotated-doc
Source0:        https://files.pythonhosted.org/packages/source/a/annotated-doc/annotated_doc-0.0.5.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n annotated_doc-0.0.5
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import annotated_doc"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 0.0.5-1
- Package annotated-doc 0.0.5 for Python 3.12 (pgAdmin 4 dependency stack)
