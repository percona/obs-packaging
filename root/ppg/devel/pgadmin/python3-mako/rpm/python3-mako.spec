...
Name:           %{python3_pkgprefix}-mako
Version:        1.4.1
Release:        1%{?dist}
Summary:        A super-fast templating language that borrows the best ideas from the existing templating languages
License:        MIT
URL:            https://www.makotemplates.org/
Source0:        https://files.pythonhosted.org/packages/source/M/Mako/mako-1.4.1.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-markupsafe >= 2.0

Requires:       %{python3_pkgprefix}-markupsafe >= 2.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import mako"
...
%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 1.4.1-1
- Package Mako 1.4.1 for Python 3.12 (pgAdmin 4 dependency stack)
