...
Name:           %{python3_pkgprefix}-itsdangerous
Version:        2.2.0
Release:        1%{?dist}
...
%prep
%autosetup -p1 -n itsdangerous-2.2.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import itsdangerous"
...
- Package itsdangerous 2.2.0 for Python 3.12 (pgAdmin 4 dependency stack)
