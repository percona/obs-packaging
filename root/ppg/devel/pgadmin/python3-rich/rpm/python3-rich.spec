...
Name:           %{python3_pkgprefix}-rich
Version:        15.0.0
Release:        1%{?dist}
Summary:        Render rich text, tables, progress bars, syntax highlighting, markdown and more to the terminal
License:        MIT
URL:            https://github.com/Textualize/rich
Source0:        https://files.pythonhosted.org/packages/source/r/rich/rich-15.0.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-markdown-it-py >= 2.2.0
BuildRequires:  %{python3_pkgprefix}-pygments >= 2.13.0

Requires:       %{python3_pkgprefix}-markdown-it-py >= 2.2.0
Requires:       %{python3_pkgprefix}-pygments >= 2.13.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import rich"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 15.0.0-1
- Package rich 15.0.0 for Python 3.12 (pgAdmin 4 dependency stack)
