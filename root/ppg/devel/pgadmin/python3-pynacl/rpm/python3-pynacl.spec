...
Name:           %{python3_pkgprefix}-pynacl
Version:        1.6.2
Release:        1%{?dist}
Summary:        Python binding to the Networking and Cryptography (NaCl) library
License:        Apache-2.0
URL:            https://github.com/pyca/pynacl
Source0:        https://files.pythonhosted.org/packages/source/P/PyNaCl/pynacl-1.6.2.tar.gz
Vendor:         Percona, LLC
...
%check
PYTHONPATH=%{buildroot}%{python3_sitearch} %{__ospython} -P -c "import nacl"

%files
%{python3_sitearch}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 1.6.2-1
- Package PyNaCl 1.6.2 for Python 3.12 (pgAdmin 4 dependency stack)
