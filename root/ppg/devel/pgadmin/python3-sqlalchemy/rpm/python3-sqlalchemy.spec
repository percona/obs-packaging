...
Name:           %{python3_pkgprefix}-sqlalchemy
Version:        2.0.52
Release:        1%{?dist}
Summary:        Database Abstraction Library
License:        MIT
URL:            https://www.sqlalchemy.org
Source0:        https://files.pythonhosted.org/packages/source/S/SQLAlchemy/sqlalchemy-2.0.52.tar.gz
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-cython
BuildRequires:  gcc
# runtime dependencies, also needed by the %check import test
BuildRequires:  %{python3_pkgprefix}-greenlet >= 1
BuildRequires:  %{python3_pkgprefix}-typing-extensions >= 4.6.0

Requires:       %{python3_pkgprefix}-greenlet >= 1
Requires:       %{python3_pkgprefix}-typing-extensions >= 4.6.0
...
%prep
%autosetup -p1 -n sqlalchemy-2.0.52
...
%check
PYTHONPATH=%{buildroot}%{python3_sitearch} %{__ospython} -P -c "import sqlalchemy"

%files
%{python3_sitearch}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 2.0.52-1
- Package SQLAlchemy 2.0.52 for Python 3.12 (pgAdmin 4 dependency stack)
