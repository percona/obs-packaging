...
Name:           %{python3_pkgprefix}-flask-login
Version:        0.6.3
Release:        1%{?dist}
Summary:        User authentication and session management for Flask
License:        MIT
URL:            https://github.com/maxcountryman/flask-login
Source0:        https://files.pythonhosted.org/packages/source/F/Flask-Login/Flask-Login-0.6.3.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-flask >= 1.0.4
BuildRequires:  %{python3_pkgprefix}-werkzeug >= 1.0.1

Requires:       %{python3_pkgprefix}-flask >= 1.0.4
Requires:       %{python3_pkgprefix}-werkzeug >= 1.0.1
...
%prep
%autosetup -p1 -n Flask-Login-0.6.3
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import flask_login"

%files -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 0.6.3-1
- Package Flask-Login 0.6.3 for Python 3.12 (pgAdmin 4 dependency stack)
