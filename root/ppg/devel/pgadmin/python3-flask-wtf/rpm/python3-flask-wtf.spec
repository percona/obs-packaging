...
BuildRequires:  %{python3_pkgprefix}-itsdangerous
BuildRequires:  %{python3_pkgprefix}-wtforms

Requires:       %{python3_pkgprefix}-flask
Requires:       %{python3_pkgprefix}-itsdangerous
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import flask_wtf"
