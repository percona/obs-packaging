...
Name:           %{python3_pkgprefix}-wsproto
Version:        1.3.2
Release:        1%{?dist}
Summary:        Pure-Python WebSocket protocol implementation
License:        MIT
URL:            https://github.com/python-hyper/wsproto/
Source0:        https://files.pythonhosted.org/packages/source/w/wsproto/wsproto-1.3.2.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-h11 >= 0.16.0

Requires:       %{python3_pkgprefix}-h11 >= 0.16.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import wsproto"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 1.3.2-1
- Package wsproto 1.3.2 for Python 3.12 (pgAdmin 4 dependency stack)
