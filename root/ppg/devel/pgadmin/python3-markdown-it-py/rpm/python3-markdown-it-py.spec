...
Name:           %{python3_pkgprefix}-markdown-it-py
Version:        4.2.0
Release:        1%{?dist}
Summary:        Python port of markdown-it. Markdown parsing, done right!
License:        MIT
URL:            https://github.com/executablebooks/markdown-it-py
Source0:        https://files.pythonhosted.org/packages/source/m/markdown-it-py/markdown_it_py-4.2.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-mdurl >= 0.1

Requires:       %{python3_pkgprefix}-mdurl >= 0.1
...
%prep
%autosetup -p1 -n markdown_it_py-4.2.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import markdown_it"
...
%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 4.2.0-1
- Package markdown-it-py 4.2.0 for Python 3.12 (pgAdmin 4 dependency stack)
