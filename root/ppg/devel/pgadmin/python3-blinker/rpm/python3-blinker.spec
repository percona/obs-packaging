...
Name:           %{python3_pkgprefix}-blinker
Version:        1.9.0
Release:        1%{?dist}
Summary:        Fast, simple object-to-object and broadcast signaling
License:        MIT
URL:            https://github.com/pallets-eco/blinker/
Source0:        https://files.pythonhosted.org/packages/source/b/blinker/blinker-1.9.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -c "import blinker"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 1.9.0-1
- Package blinker 1.9.0 for Python 3.12 (pgAdmin 4 dependency stack)
