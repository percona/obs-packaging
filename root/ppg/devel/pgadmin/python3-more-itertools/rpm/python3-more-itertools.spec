...
Name:           %{python3_pkgprefix}-more-itertools
Version:        11.1.0
Release:        1%{?dist}
Summary:        More routines for operating on iterables, beyond itertools
License:        MIT
URL:            https://github.com/more-itertools/more-itertools
Source0:        https://files.pythonhosted.org/packages/source/m/more-itertools/more_itertools-11.1.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n more_itertools-11.1.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import more_itertools"
...
- Package more-itertools 11.1.0 for Python 3.12 (pgAdmin 4 dependency stack)
