...
Name:           %{python3_pkgprefix}-markupsafe
Version:        3.0.3
Release:        1%{?dist}
Summary:        Safely add untrusted strings to HTML/XML markup
License:        BSD-3-Clause
URL:            https://github.com/pallets/markupsafe/
Source0:        https://files.pythonhosted.org/packages/source/M/MarkupSafe/markupsafe-3.0.3.tar.gz
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n markupsafe-3.0.3
...
%check
PYTHONPATH=%{buildroot}%{python3_sitearch} %{__ospython} -P -c "import markupsafe"

%files
%{python3_sitearch}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 3.0.3-1
- Package MarkupSafe 3.0.3 for Python 3.12 (pgAdmin 4 dependency stack)
