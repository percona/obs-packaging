...
Name:           %{python3_pkgprefix}-sshtunnel
Version:        0.4.0
Release:        1%{?dist}
Summary:        Pure python SSH tunnels
License:        MIT
URL:            https://github.com/pahaz/sshtunnel
Source0:        https://files.pythonhosted.org/packages/source/s/sshtunnel/sshtunnel-0.4.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n sshtunnel-0.4.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import sshtunnel"
...
- Package sshtunnel 0.4.0 for Python 3.12 (pgAdmin 4 dependency stack)
