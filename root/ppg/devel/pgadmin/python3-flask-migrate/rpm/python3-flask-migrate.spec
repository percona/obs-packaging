...
Name:           %{python3_pkgprefix}-flask-migrate
Version:        4.1.0
Release:        1%{?dist}
Summary:        SQLAlchemy database migrations for Flask applications using Alembic
License:        MIT
URL:            https://github.com/miguelgrinberg/flask-migrate
Source0:        https://files.pythonhosted.org/packages/source/F/Flask-Migrate/flask_migrate-4.1.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-flask-sqlalchemy >= 1.0
BuildRequires:  %{python3_pkgprefix}-alembic >= 1.9.0

Requires:       %{python3_pkgprefix}-flask >= 0.9
Requires:       %{python3_pkgprefix}-flask-sqlalchemy >= 1.0
Requires:       %{python3_pkgprefix}-alembic >= 1.9.0
...
%prep
%autosetup -p1 -n flask_migrate-4.1.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import flask_migrate"
...
- Package Flask-Migrate 4.1.0 for Python 3.12 (pgAdmin 4 dependency stack)
