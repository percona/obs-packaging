...
Name:           %{python3_pkgprefix}-werkzeug
Version:        3.1.8
Release:        1%{?dist}
Summary:        The comprehensive WSGI web application library
License:        BSD-3-Clause
URL:            https://github.com/pallets/werkzeug/
Source0:        https://files.pythonhosted.org/packages/source/W/Werkzeug/werkzeug-3.1.8.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import werkzeug"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 3.1.8-1
- Package Werkzeug 3.1.8 for Python 3.12 (pgAdmin 4 dependency stack)
