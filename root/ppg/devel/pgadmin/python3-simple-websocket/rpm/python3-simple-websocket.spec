...
Name:           %{python3_pkgprefix}-simple-websocket
Version:        1.1.0
Release:        1%{?dist}
Summary:        Simple WebSocket server and client for Python
License:        MIT
URL:            https://github.com/miguelgrinberg/simple-websocket
Source0:        https://files.pythonhosted.org/packages/source/s/simple-websocket/simple_websocket-1.1.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-wsproto

Requires:       %{python3_pkgprefix}-wsproto
...
%prep
%autosetup -p1 -n simple_websocket-1.1.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import simple_websocket"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 1.1.0-1
- Package simple-websocket 1.1.0 for Python 3.12 (pgAdmin 4 dependency stack)
