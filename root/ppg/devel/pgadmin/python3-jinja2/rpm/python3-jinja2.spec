...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import jinja2"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 3.1.6-1
- Package Jinja2 3.1.6 for Python 3.12 (pgAdmin 4 dependency stack)
