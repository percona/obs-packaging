...
Name:           %{python3_pkgprefix}-jsonformatter
Version:        0.3.4
Release:        1%{?dist}
Summary:        Python log in json format
License:        MIT
URL:            https://github.com/MyColorfulDays/jsonformatter.git
Source0:        https://files.pythonhosted.org/packages/source/j/jsonformatter/jsonformatter-0.3.4.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n jsonformatter-0.3.4
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import jsonformatter"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 0.3.4-1
- Package jsonformatter 0.3.4 for Python 3.12 (pgAdmin 4 dependency stack)
