...
Name:           %{python3_pkgprefix}-mdurl
Version:        0.1.2
Release:        1%{?dist}
Summary:        Markdown URL utilities
License:        MIT
URL:            https://github.com/executablebooks/mdurl
Source0:        https://files.pythonhosted.org/packages/source/m/mdurl/mdurl-0.1.2.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import mdurl"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 0.1.2-1
- Package mdurl 0.1.2 for Python 3.12 (pgAdmin 4 dependency stack)
