...
Name:           %{python3_pkgprefix}-typing-extensions
Version:        4.16.0
Release:        1%{?dist}
Summary:        Backported and Experimental Type Hints for Python 3.9+
License:        PSF-2.0
URL:            https://pypi.org/project/typing-extensions/
Source0:        https://files.pythonhosted.org/packages/source/t/typing-extensions/typing_extensions-4.16.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n typing_extensions-4.16.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import typing_extensions"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 4.16.0-1
- Package typing-extensions 4.16.0 for Python 3.12 (pgAdmin 4 dependency stack)
