...
Name:           %{python3_pkgprefix}-user-agents
Version:        2.2.0
Release:        1%{?dist}
...
Source0:        https://files.pythonhosted.org/packages/source/u/user-agents/user-agents-2.2.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-ua-parser

Requires:       %{python3_pkgprefix}-ua-parser
...
%prep
%autosetup -p1 -n user-agents-2.2.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import user_agents"

%files -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 2.2.0-1
- Package user-agents 2.2.0 for Python 3.12 (pgAdmin 4 dependency stack)
