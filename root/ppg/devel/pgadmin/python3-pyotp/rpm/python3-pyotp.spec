...
Name:           %{python3_pkgprefix}-pyotp
Version:        2.9.0
Release:        1%{?dist}
Summary:        Python One Time Password Library
License:        MIT
URL:            https://github.com/pyotp/pyotp
Source0:        https://files.pythonhosted.org/packages/source/P/PyOTP/pyotp-2.9.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import pyotp"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 2.9.0-1
- Package PyOTP 2.9.0 for Python 3.12 (pgAdmin 4 dependency stack)
