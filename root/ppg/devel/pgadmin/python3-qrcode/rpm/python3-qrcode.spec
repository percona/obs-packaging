...
Name:           %{python3_pkgprefix}-qrcode
Version:        8.2
Release:        1%{?dist}
Summary:        QR Code image generator
License:        BSD-3-Clause
URL:            https://github.com/lincolnloop/python-qrcode
Source0:        https://files.pythonhosted.org/packages/source/q/qrcode/qrcode-8.2.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import qrcode"
...
%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 8.2-1
- Package qrcode 8.2 for Python 3.12 (pgAdmin 4 dependency stack)
