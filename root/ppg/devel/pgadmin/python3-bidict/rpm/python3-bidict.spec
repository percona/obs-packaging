...
Name:           %{python3_pkgprefix}-bidict
Version:        0.23.1
Release:        1%{?dist}
Summary:        The bidirectional mapping library for Python
License:        MPL-2.0
URL:            https://pypi.org/project/bidict/
Source0:        https://files.pythonhosted.org/packages/source/b/bidict/bidict-0.23.1.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import bidict"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 0.23.1-1
- Package bidict 0.23.1 for Python 3.12 (pgAdmin 4 dependency stack)
