...
Name:           %{python3_pkgprefix}-babel
Version:        2.18.0
Release:        1%{?dist}
Summary:        Internationalization utilities
License:        BSD-3-Clause
URL:            https://babel.pocoo.org/
Source0:        https://files.pythonhosted.org/packages/source/b/babel/babel-2.18.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import babel"
...
%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 2.18.0-1
- Package babel 2.18.0 for Python 3.12 (pgAdmin 4 dependency stack)
