...
Name:           %{python3_pkgprefix}-authlib
Version:        1.6.12
Release:        1%{?dist}
Summary:        The ultimate Python library in building OAuth and OpenID Connect servers and clients
License:        BSD-3-Clause
URL:            https://github.com/authlib/authlib
Source0:        https://files.pythonhosted.org/packages/source/A/Authlib/authlib-1.6.12.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import authlib"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 1.6.12-1
- Package Authlib 1.6.12 for Python 3.12 (pgAdmin 4 dependency stack)
