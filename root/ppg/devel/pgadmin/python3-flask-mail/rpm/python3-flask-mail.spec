...
Name:           %{python3_pkgprefix}-flask-mail
Version:        0.10.0
Release:        1%{?dist}
Summary:        Flask extension for sending email
License:        BSD-3-Clause
URL:            https://github.com/pallets-eco/flask-mail/
Source0:        https://files.pythonhosted.org/packages/source/F/Flask-Mail/flask_mail-0.10.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n flask_mail-0.10.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import flask_mail"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 0.10.0-1
- Package Flask-Mail 0.10.0 for Python 3.12 (pgAdmin 4 dependency stack)
