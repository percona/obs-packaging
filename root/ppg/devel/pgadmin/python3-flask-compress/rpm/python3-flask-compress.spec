...
Name:           %{python3_pkgprefix}-flask-compress
Version:        1.24
Release:        1%{?dist}
Summary:        Compress responses in your Flask app with gzip, deflate, brotli or zstandard
License:        MIT
URL:            https://github.com/colour-science/flask-compress
Source0:        https://files.pythonhosted.org/packages/source/F/Flask-Compress/flask_compress-1.24.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-brotli
BuildRequires:  %{python3_pkgprefix}-backports-zstd

Requires:       %{python3_pkgprefix}-flask
Requires:       %{python3_pkgprefix}-brotli
Requires:       %{python3_pkgprefix}-backports-zstd
...
%prep
%autosetup -p1 -n flask_compress-1.24
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import flask_compress"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 1.24-1
- Package Flask-Compress 1.24 for Python 3.12 (pgAdmin 4 dependency stack)
