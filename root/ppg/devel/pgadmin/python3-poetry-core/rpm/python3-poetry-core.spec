...
Name:           %{python3_pkgprefix}-poetry-core
Version:        2.2.1
Release:        1%{?dist}
Summary:        Poetry PEP 517 Build Backend
License:        MIT
URL:            https://github.com/python-poetry/poetry-core
Source0:        https://files.pythonhosted.org/packages/source/p/poetry-core/poetry_core-2.2.1.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n poetry_core-2.2.1
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import poetry.core.masonry.api"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 2.2.1-1
- Package poetry-core 2.2.1 for Python 3.12 (pgAdmin 4 dependency stack)
