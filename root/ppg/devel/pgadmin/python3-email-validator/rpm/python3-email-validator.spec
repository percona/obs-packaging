...
Name:           %{python3_pkgprefix}-email-validator
Version:        2.3.0
Release:        1%{?dist}
Summary:        A robust email address syntax and deliverability validation library
License:        Unlicense
URL:            https://github.com/JoshData/python-email-validator
Source0:        https://files.pythonhosted.org/packages/source/e/email-validator/email_validator-2.3.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
BuildRequires:  %{python3_pkgprefix}-dns
BuildRequires:  python3.12-idna
...
%prep
%autosetup -p1 -n email_validator-2.3.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import email_validator"
...
%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 2.3.0-1
- Package email-validator 2.3.0 for Python 3.12 (pgAdmin 4 dependency stack)
