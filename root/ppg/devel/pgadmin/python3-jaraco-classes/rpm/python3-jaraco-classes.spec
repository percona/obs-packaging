...
Name:           %{python3_pkgprefix}-jaraco-classes
Version:        3.4.0
Release:        1%{?dist}
Summary:        Utility functions for Python class constructs
License:        MIT
URL:            https://github.com/jaraco/jaraco.classes
Source0:        https://files.pythonhosted.org/packages/source/j/jaraco.classes/jaraco.classes-3.4.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n jaraco.classes-3.4.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import jaraco.classes"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 3.4.0-1
- Package jaraco.classes 3.4.0 for Python 3.12 (pgAdmin 4 dependency stack)
