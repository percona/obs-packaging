...
Name:           %{python3_pkgprefix}-pathspec
Version:        0.12.1
Release:        1%{?dist}
Summary:        Utility library for gitignore style pattern matching of file paths
License:        MPL-2.0
URL:            https://pypi.org/project/pathspec/
Source0:        https://files.pythonhosted.org/packages/source/p/pathspec/pathspec-0.12.1.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n pathspec-0.12.1
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import pathspec"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 0.12.1-1
- Package pathspec 0.12.1 for Python 3.12 (shared Python 3.12 build stack)
