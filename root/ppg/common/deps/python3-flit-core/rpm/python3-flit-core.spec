...
Name:           %{python3_pkgprefix}-flit-core
Version:        3.12.0
Release:        1%{?dist}
Summary:        Distribution-building parts of Flit. See flit package for more information
License:        BSD-3-Clause
URL:            https://github.com/pypa/flit
Source0:        https://files.pythonhosted.org/packages/source/f/flit-core/flit_core-3.12.0.tar.gz
BuildArch:      noarch
Vendor:         Percona, LLC
...
%prep
%autosetup -p1 -n flit_core-3.12.0
...
%check
PYTHONPATH=%{buildroot}%{python3_sitelib} %{__ospython} -P -c "import flit_core.buildapi"

%files
%{python3_sitelib}/*

%changelog
* Thu Aug 27 2026 Percona Development Team <info@percona.com> - 3.12.0-1
- Package flit-core 3.12.0 for Python 3.12 (shared Python 3.12 build stack)
