...
%if %sysuserd
Source20:        %{sname}-sysusers.conf
%endif
Source30:       percona-postgresql-extensions-macros
Source999:       percona-postgresql-rpmlintrc
...
install -D -m 0644 %{SOURCE30} %{buildroot}%{_rpmmacrodir}/macros.percona-postgresql
