...
BuildRequires:  libjson-c-devel liblz4-devel libnuma-devel
...
BuildRequires:  gcc-c++
%else
BuildRequires:  json-c-devel lz4-devel numactl-devel
%endif
BuildRequires:  clang llvm
%if 0%{?suse_version} >= 1500
Requires:       libjson-c5 curl libopenssl3 libnuma1
%else
Requires:       json-c curl openssl numactl-libs
%endif
