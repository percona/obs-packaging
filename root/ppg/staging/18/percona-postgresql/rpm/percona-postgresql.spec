...
# (Ported from the staging:17 spec — first PG 18 ssl3 tarball shipped a
# plpython3 embedding the EL9 system python 3.9, which fatals on every
# Debian-family host: "No module named 'encodings'".)
...
# /usr/lib/llvm19/bin/llvm-config, not /usr/bin/llvm-config-19). Let PG's
